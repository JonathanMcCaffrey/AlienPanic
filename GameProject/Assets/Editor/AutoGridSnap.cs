...
public static class AutoGridSnap
{
    ...
    public static void Update()
    {
        ...
        snapValueX = EditorPrefs.GetFloat("AutoGridSnap.MoveSnapX", 1.0f);
        snapValueY = EditorPrefs.GetFloat("AutoGridSnap.MoveSnapY", 1.0f);
        snapValueZ = EditorPrefs.GetFloat("AutoGridSnap.MoveSnapZ", 1.0f);
